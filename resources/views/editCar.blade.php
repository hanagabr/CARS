					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{route('editCar',$cars->id)}}" method="post" enctype="multipart/form-data">
										@csrf
										@method('put')
									...
									<div class="item form-group">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<textarea id="content" name="content" required="required" class="form-control" name="content">{{ $cars->content }}"</textarea>
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input id="passengers" class="form-control" type="number" name="passangers" required="required" value="{{ $cars->passangers }}">
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align"name="active" @checked($cars->Active) >Active</label>
											<div class="checkbox">
												<label>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												...
												@foreach($cats as $cat)
													<option value=" {{ $cat->id }}" @selected( $cat->id == $cars->id)> {{$cat->category_name}}</option>
