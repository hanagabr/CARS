								...
								<div class="x_content">
									...
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{route('addCar')}}" method="post" enctype="multipart/form-data">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<textarea id="content" name="content" required="required" class="form-control" name="contents">Contents</textarea>
												@error('content')
                                                   {{ $message }}
                                                     @enderror
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input id="passengers" class="form-control" type="number" name="passangers" required="required">
