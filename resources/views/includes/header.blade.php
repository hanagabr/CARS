    ...
    <div class="col-9  text-right">
      ...
      <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
        <ul class="site-menu main-menu js-clone-nav ml-auto ">
          <li><a href="{{route('cars')}}" class="nav-link">Home</a></li>
          <li><a href="{{route('listing')}}" class="nav-link{{request()->is('listing') ? 'active':''}}">Listing</a></li>
          <li class="active"><a href="{{route('testimonials')}}" class="nav-link{{request()->is('testimonials') ? 'active':''}}">Testimonials</a></li>
