...
@include('includes.header')
    ...
    <script src="{{asset('assets/js/jquery-3.3.1.min.jpg')}}"></script>
    <script src="{{asset('assets/js/popper.min.jpg')}}"></script>
    <script src="{{asset('assets/js/bootstrap.min.jpg')}}"></script>
    <script src="{{asset('assets/js/owl.carousel.min.jpg')}}"></script>
    <script src="{{asset('assets/js/jquery.sticky.jpg')}}"></script>
    <script src="{{asset('assets/js/jquery.waypoints.min.jpg')}}"></script>
    <script src="{{asset('assets/js/jquery.animateNumber.min.jpg')}}"></script>
    <script src="{{asset('assets/js/jquery.fancybox.min.jpg')}}"></script>
    <script src="{{asset('assets/js/jquery.easing.1.3.jpg')}}"></script>
    <script src="{{asset('assets/js/bootstrap-datepicker.min.jpg')}}"></script>
    <script src="{{asset('assets/js/aos.jpg')}}"></script>

    <script src="{{asset('assets/js/main.jpg')}}"></script>
